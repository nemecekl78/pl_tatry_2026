...
source_data: {
  ...
  trails: [
    {id:"t1_01", dest_lat:49.2354, dest_lng:19.859, name:"Dolina Kościeliska → Schronisko Ornak", area:"Tatry", difficulty:"T1", trailhead:"Kiry", trailhead_lat:49.2782, trailhead_lng:19.8759, trailhead_elev:930, distance_km:11, duration_min:180, elevation_gain_m:250, chains:false, weather_gate:"soft", country:"PL", highlights:"nejkrásnější polské údolí, jeskyně, Smreczyński Staw poblíž"},
    {id:"t1_02", dest_lat:49.264, dest_lng:19.945, name:"Dolina Strążyska → wodospad Siklawica", area:"Tatry", difficulty:"T1", trailhead:"Zakopane-Strążyska", trailhead_lat:49.2769, trailhead_lng:19.9436, trailhead_elev:900, distance_km:5, duration_min:120, elevation_gain_m:200, chains:false, weather_gate:"soft", country:"PL", highlights:"vodopád pod Giewontem, snadné a stinné"},
    {id:"t1_03", dest_lat:49.271, dest_lng:19.96, name:"Dolina Białego (pętla)", area:"Tatry", difficulty:"T1", trailhead:"Zakopane-Biały Potok", trailhead_lat:49.2803, trailhead_lng:19.9540, trailhead_elev:900, distance_km:6, duration_min:150, elevation_gain_m:250, chains:false, weather_gate:"soft", country:"PL", highlights:"potok, lávky, okruh blízko centra"},
    {id:"t1_04", dest_lat:49.268, dest_lng:19.93, name:"Dolina za Bramką", area:"Tatry", difficulty:"T1", trailhead:"Zakopane-Za Bramką", trailhead_lat:49.2760, trailhead_lng:19.9330, trailhead_elev:900, distance_km:4, duration_min:90, elevation_gain_m:150, chains:false, weather_gate:"soft", country:"PL", highlights:"krátká zalesněná roklina, klid"},
    {id:"t1_05", dest_lat:49.26, dest_lng:19.86, name:"Dolina Lejowa", area:"Tatry", difficulty:"T1", trailhead:"Kiry", trailhead_lat:49.2782, trailhead_lng:19.8759, trailhead_elev:930, distance_km:8, duration_min:150, elevation_gain_m:150, chains:false, weather_gate:"soft", country:"PL", highlights:"tiché údolí, minimum lidí, ideál pro e-kolo"},
    {id:"t1_06", dest_lat:49.271, dest_lng:20.015, name:"Toporowy Staw Niżni (od Jaszczurówki)", area:"Tatry", difficulty:"T1", trailhead:"Jaszczurówka", trailhead_lat:49.2846, trailhead_lng:20.0140, trailhead_elev:940, distance_km:7, duration_min:150, elevation_gain_m:150, chains:false, weather_gate:"soft", country:"PL", highlights:"lesní plesa, ticho"},
    {id:"t1_07", dest_lat:49.224, dest_lng:19.876, name:"Smreczyński Staw (z Doliny Kościeliskiej)", area:"Tatry", difficulty:"T1", trailhead:"Kiry", trailhead_lat:49.2782, trailhead_lng:19.8759, trailhead_elev:930, distance_km:13, duration_min:210, elevation_gain_m:260, chains:false, weather_gate:"soft", country:"PL", highlights:"klidné pleso, delší ale rovinaté údolí"},
    {id:"t1_08", dest_lat:49.404, dest_lng:20.56, name:"Wąwóz Homole", area:"Pieniny", difficulty:"T1", trailhead:"Jaworki", trailhead_lat:49.4103, trailhead_lng:20.5560, trailhead_elev:560, distance_km:4, duration_min:120, elevation_gain_m:200, chains:false, weather_gate:"soft", country:"PL", highlights:"efektní skalní roklina, jeden z nejhezčích snadných výletů"},
    {id:"t1_09", dest_lat:49.437, dest_lng:20.307, name:"Ruiny zamku Czorsztyn + promenada nad jezerem", area:"Pieniny", difficulty:"T1", trailhead:"Czorsztyn", trailhead_lat:49.4380, trailhead_lng:20.3060, trailhead_elev:540, distance_km:3, duration_min:90, elevation_gain_m:100, chains:false, weather_gate:"soft", country:"PL", highlights:"hradní ruina, výhled na jezero a Niedzicu"},
    {id:"t1_10", dest_lat:49.418, dest_lng:20.42, name:"Droga Pienińska – promenada Szczawnica ↔ Przełom", area:"Pieniny", difficulty:"T1", trailhead:"Szczawnica", trailhead_lat:49.4300, trailhead_lng:20.4880, trailhead_elev:470, distance_km:8, duration_min:150, elevation_gain_m:100, chains:false, weather_gate:"soft", country:"PL", highlights:"rovinatá cesta podél Dunajce, lze i na kole"},

    {id:"t2_01", dest_lat:49.245, dest_lng:20.075, name:"Rusinowa Polana → Gęsia Szyja", area:"Tatry", difficulty:"T2", trailhead:"Palenica Białczańska", trailhead_lat:49.2558, trailhead_lng:20.1031, trailhead_elev:980, distance_km:12, duration_min:240, elevation_gain_m:520, chains:false, weather_gate:"hard", country:"PL", highlights:"panorama Vysokých Tater, méně davů než Morskie Oko"},
    {id:"t2_02", dest_lat:49.2314, dest_lng:19.9817, name:"Kasprowy Wierch → Dolina Gąsienicowa → Czarny Staw → Kuźnice", area:"Tatry", difficulty:"T2", trailhead:"Kuźnice (lanovka)", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, summit_lat:49.2314, summit_lng:19.9817, summit_elev:1987, distance_km:10, duration_min:240, elevation_gain_m:300, chains:false, weather_gate:"hard", country:"PL", highlights:"vysokohorský výhled s pomocí lanovky, převážně sestup"},
    {id:"t2_03", dest_lat:49.267, dest_lng:19.955, name:"Sarnia Skała (z Doliny Białego)", area:"Tatry", difficulty:"T2", trailhead:"Zakopane-Biały Potok", trailhead_lat:49.2803, trailhead_lng:19.9540, trailhead_elev:900, distance_km:9, duration_min:210, elevation_gain_m:500, chains:false, weather_gate:"hard", country:"PL", highlights:"výhledová skála nad Zakopaným"},
    {id:"t2_04", dest_lat:49.276, dest_lng:19.99, name:"Nosal", area:"Tatry", difficulty:"T2", trailhead:"Kuźnice", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, distance_km:4, duration_min:150, elevation_gain_m:350, chains:false, weather_gate:"hard", country:"PL", highlights:"krátký strmý výstup, velký výhled za málo km"},
    {id:"t2_05", dest_lat:49.201, dest_lng:20.07, name:"Morskie Oko (z Palenicy)", area:"Tatry", difficulty:"T2", trailhead:"Palenica Białczańska", trailhead_lat:49.2558, trailhead_lng:20.1031, trailhead_elev:980, summit_lat:49.2010, summit_lng:20.0700, summit_elev:1410, distance_km:18, duration_min:300, elevation_gain_m:500, chains:false, weather_gate:"hard", country:"PL", highlights:"nejslavnější ples; dlouhá, ale po asfaltce – jen výrazně dřív kvůli davům"},
    {id:"t2_06", dest_lat:49.243, dest_lng:20.006, name:"Hala Gąsienicowa – Murowaniec (z Kuźnic pěšky)", area:"Tatry", difficulty:"T2", trailhead:"Kuźnice", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, summit_elev:1500, distance_km:11, duration_min:240, elevation_gain_m:600, chains:false, weather_gate:"hard", country:"PL", highlights:"klasika k útulně Murowaniec bez lanovky"},
    {id:"t2_07", dest_lat:49.271, dest_lng:20.01, name:"Wielki Kopieniec", area:"Tatry", difficulty:"T2", trailhead:"Toporowa Cyrhla", trailhead_lat:49.2860, trailhead_lng:20.0170, trailhead_elev:1000, distance_km:8, duration_min:210, elevation_gain_m:400, chains:false, weather_gate:"hard", country:"PL", highlights:"travnatý vrchol, kruhový výhled na Tatry"},
    {id:"t2_08", dest_lat:49.245, dest_lng:19.965, name:"Hala Kondratowa + Kalatówki", area:"Tatry", difficulty:"T2", trailhead:"Kuźnice", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, distance_km:9, duration_min:210, elevation_gain_m:450, chains:false, weather_gate:"hard", country:"PL", highlights:"louky pod Giewontem, útulna Kondratowa"},
    {id:"t2_09", dest_lat:49.41, dest_lng:20.412, name:"Trzy Korony (Okrąglica)", area:"Pieniny", difficulty:"T2", trailhead:"Sromowce Niżne / Krościenko", trailhead_lat:49.3986, trailhead_lng:20.4139, trailhead_elev:450, summit_elev:982, distance_km:10, duration_min:240, elevation_gain_m:500, chains:true, weather_gate:"hard", country:"PL", highlights:"ikonický vrchol s vyhlídkovou plošinou nad Przełomem (rezervace vstupu)"},
    {id:"t2_10", dest_lat:49.41, dest_lng:20.42, name:"Sokolica (widok na Przełom Dunajca)", area:"Pieniny", difficulty:"T2", trailhead:"Krościenko", trailhead_lat:49.4380, trailhead_lng:20.4230, trailhead_elev:430, summit_elev:747, distance_km:9, duration_min:210, elevation_gain_m:400, chains:false, weather_gate:"hard", country:"PL", highlights:"nejfotografovanější zákrut Dunajce, borovice na skále"},

    {id:"t3_01", dest_lat:49.204, dest_lng:20.038, name:"Dolina Pięciu Stawów Polskich + wodospad Siklawa", area:"Tatry", difficulty:"T3", trailhead:"Palenica Białczańska", trailhead_lat:49.2558, trailhead_lng:20.1031, trailhead_elev:980, summit_elev:1700, distance_km:23, duration_min:450, elevation_gain_m:900, chains:false, weather_gate:"hard", country:"PL", highlights:"údolí pěti ples + největší polský vodopád; jedna z nejkrásnějších túr"},
    {id:"t3_02", dest_lat:49.2506, dest_lng:19.9331, name:"Giewont (z Kuźnic přes Halę Kondratową)", area:"Tatry", difficulty:"T3", trailhead:"Kuźnice", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, summit_elev:1895, distance_km:13, duration_min:360, elevation_gain_m:900, chains:true, weather_gate:"hard", country:"PL", highlights:"symbol Zakopaného, řetězy u vrcholu; za bouřky NEchodit (kříž = blesky)"},
    {id:"t3_03", dest_lat:49.196, dest_lng:20.03, name:"Szpiglasowy Wierch (z Morskiego Oka)", area:"Tatry", difficulty:"T3", trailhead:"Palenica Białczańska", trailhead_lat:49.2558, trailhead_lng:20.1031, trailhead_elev:980, summit_elev:2172, distance_km:20, duration_min:420, elevation_gain_m:900, chains:true, weather_gate:"hard", country:"PL", highlights:"výhled na Morskie Oko i Pięć Stawów najednou"},
    {id:"t3_04", dest_lat:49.212, dest_lng:20.006, name:"Kościelec (z Hali Gąsienicowej)", area:"Tatry", difficulty:"T3", trailhead:"Kuźnice", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, summit_elev:2155, distance_km:12, duration_min:360, elevation_gain_m:700, chains:true, weather_gate:"hard", country:"PL", highlights:"efektní pyramida nad Czarnym Stawem, expozice u vrcholu"},
    {id:"t3_05", dest_lat:49.22, dest_lng:19.912, name:"Małołączniak (Czerwone Wierchy)", area:"Tatry", difficulty:"T3", trailhead:"Dolina Małej Łąki", trailhead_lat:49.2731, trailhead_lng:19.8940, trailhead_elev:950, summit_elev:2096, distance_km:14, duration_min:420, elevation_gain_m:1100, chains:false, weather_gate:"hard", country:"PL", highlights:"travnaté hřebeny Czerwonych Wierchów, daleké výhledy"},
    {id:"t3_06", dest_lat:49.222, dest_lng:19.741, name:"Wołowiec (z Doliny Chochołowskiej)", area:"Tatry", difficulty:"T3", trailhead:"Siwa Polana", trailhead_lat:49.2589, trailhead_lng:19.7906, trailhead_elev:930, summit_elev:2064, distance_km:20, duration_min:420, elevation_gain_m:1000, chains:false, weather_gate:"hard", country:"PL", highlights:"hraniční vrchol Západních Tater"},
    {id:"t3_07", dest_lat:49.216, dest_lng:20.019, name:"Skrajny Granat (z Hali Gąsienicowej)", area:"Tatry", difficulty:"T3", trailhead:"Kuźnice", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, summit_elev:2225, distance_km:14, duration_min:420, elevation_gain_m:900, chains:true, weather_gate:"hard", country:"PL", highlights:"nejsnáze dostupný vrchol Orlej Perci, řetězy"},
    {id:"t3_08", dest_lat:49.222, dest_lng:19.905, name:"Ciemniak / Krzesanica (z Doliny Kościeliskiej)", area:"Tatry", difficulty:"T3", trailhead:"Kiry", trailhead_lat:49.2782, trailhead_lng:19.8759, trailhead_elev:930, summit_elev:2122, distance_km:18, duration_min:450, elevation_gain_m:1100, chains:false, weather_gate:"hard", country:"PL", highlights:"vápencové hřebeny, jeskyně Smocza Jama poblíž"},
    {id:"t3_09", dest_lat:49.213, dest_lng:19.792, name:"Starorobociański Wierch (z Chochołowskiej)", area:"Tatry", difficulty:"T3", trailhead:"Siwa Polana", trailhead_lat:49.2589, trailhead_lng:19.7906, trailhead_elev:930, summit_elev:2176, distance_km:24, duration_min:480, elevation_gain_m:1150, chains:false, weather_gate:"hard", country:"PL", highlights:"nejvyšší vrchol polských Západních Tater"},
    {id:"t3_10", dest_lat:49.198, dest_lng:20.028, name:"Szpiglasowa Przełęcz + Wrota Chałubińskiego (pętla)", area:"Tatry", difficulty:"T3", trailhead:"Palenica Białczańska", trailhead_lat:49.2558, trailhead_lng:20.1031, trailhead_elev:980, summit_elev:2110, distance_km:22, duration_min:480, elevation_gain_m:900, chains:true, weather_gate:"hard", country:"PL", highlights:"průchod mezi kotly, řetězy, velký okruh"},

    {id:"t4_01", dest_lat:49.1795, dest_lng:20.0881, name:"Rysy (2499 m, z Morskiego Oka)", area:"Tatry", difficulty:"T4", trailhead:"Palenica Białczańska", trailhead_lat:49.2558, trailhead_lng:20.1031, trailhead_elev:980, summit_elev:2499, distance_km:24, duration_min:570, elevation_gain_m:1200, chains:true, weather_gate:"hard_strict", country:"PL", highlights:"nejvyšší dostupný bod Polska, řetězy, celodenní; jen za jistého počasí"},
    {id:"t4_02", dest_lat:49.204, dest_lng:20.023, name:"Orla Perć: Zawrat → Kozi Wierch", area:"Tatry", difficulty:"T4", trailhead:"Kuźnice / Dolina Gąsienicowa", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, summit_elev:2291, distance_km:16, duration_min:540, elevation_gain_m:1000, chains:true, weather_gate:"hard_strict", country:"PL", highlights:"nejexponovanější značená cesta v Polsku; jednosměrná, jen zkušení"},
    {id:"t4_03", dest_lat:49.227, dest_lng:20.048, name:"Orla Perć: Kozi Wierch → Krzyżne", area:"Tatry", difficulty:"T4", trailhead:"Dolina Pięciu Stawów", trailhead_lat:49.2200, trailhead_lng:20.0450, trailhead_elev:1670, summit_elev:2291, distance_km:18, duration_min:540, elevation_gain_m:1000, chains:true, weather_gate:"hard_strict", country:"PL", highlights:"druhá polovina hřebene, dlouhé řetězové úseky"},
    {id:"t4_04", dest_lat:49.2226, dest_lng:19.9906, name:"Świnica granią z Kasprowego Wierchu", area:"Tatry", difficulty:"T4", trailhead:"Kuźnice (lanovka)", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, summit_elev:2301, distance_km:12, duration_min:420, elevation_gain_m:600, chains:true, weather_gate:"hard_strict", country:"PL", highlights:"exponovaný hřeben přes Liliowe, řetězy"},
    {id:"t4_05", dest_lat:49.211, dest_lng:20.01, name:"Zawrat (z Doliny Gąsienicowej)", area:"Tatry", difficulty:"T4", trailhead:"Kuźnice", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, summit_elev:2159, distance_km:14, duration_min:450, elevation_gain_m:900, chains:true, weather_gate:"hard_strict", country:"PL", highlights:"slavné sedlo, strmý řetězový výstup"},
    {id:"t4_06", dest_lat:49.216, dest_lng:20.021, name:"Granaty (Skrajny–Pośredni–Zadni)", area:"Tatry", difficulty:"T4", trailhead:"Kuźnice / Dolina Gąsienicowa", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, summit_elev:2240, distance_km:16, duration_min:480, elevation_gain_m:950, chains:true, weather_gate:"hard_strict", country:"PL", highlights:"tři vrcholy Orlej Perci v řadě"},
    {id:"t4_07", dest_lat:49.207, dest_lng:20.02, name:"Kozia Przełęcz + Kozie Czuby (Orla Perć)", area:"Tatry", difficulty:"T4", trailhead:"Dolina Pięciu Stawów", trailhead_lat:49.2200, trailhead_lng:20.0450, trailhead_elev:1670, summit_elev:2263, distance_km:17, duration_min:510, elevation_gain_m:1000, chains:true, weather_gate:"hard_strict", country:"PL", highlights:"nejtěžší partie hřebene, drápkování"},
    {id:"t4_08", dest_lat:49.223, dest_lng:20.035, name:"Buczynowe Turnie (Orla Perć wschodnia)", area:"Tatry", difficulty:"T4", trailhead:"Dolina Pięciu Stawów", trailhead_lat:49.2200, trailhead_lng:20.0450, trailhead_elev:1670, summit_elev:2184, distance_km:19, duration_min:540, elevation_gain_m:1000, chains:true, weather_gate:"hard_strict", country:"PL", highlights:"klidnější, ale technicky náročný konec Orlej Perci"},
    {id:"t4_09", dest_lat:49.187, dest_lng:20.07, name:"Przełęcz pod Chłopkiem (z Morskiego Oka)", area:"Tatry", difficulty:"T4", trailhead:"Palenica Białczańska", trailhead_lat:49.2558, trailhead_lng:20.1031, trailhead_elev:980, summit_elev:2307, distance_km:22, duration_min:540, elevation_gain_m:1150, chains:true, weather_gate:"hard_strict", country:"PL", highlights:"strmý řetězový výstup nad Czarny Staw pod Mięguszowieckie"},
    {id:"t4_10", dest_lat:49.2506, dest_lng:19.9331, name:"Grań Czerwonych Wierchów: Kasprowy → Małołączniak → Giewont", area:"Tatry", difficulty:"T4", trailhead:"Kuźnice (lanovka)", trailhead_lat:49.2669, trailhead_lng:19.9825, trailhead_elev:1010, summit_elev:2122, distance_km:20, duration_min:600, elevation_gain_m:1000, chains:true, weather_gate:"hard_strict", country:"PL", highlights:"dlouhý celodenní přechod hřebene s finálním Giewontem"}
  ],
